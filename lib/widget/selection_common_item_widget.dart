...
class SelectionCommonItemWidget extends StatelessWidget {
  /// 单项数据
  ...
  /// 单选回调
  final ValueChanged<SelectionEntity>? itemSelectFunction;
        ...
        child: Align(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Visibility(
                visible: !PhoenixTools.isEmpty(item.subTitle),
                child: Padding(
                  padding:
